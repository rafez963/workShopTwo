...
// destino del viaje 
const destinoViaje =  pront("Por favor ingresa el destino de tu viaje: ")
console.log('El destino del viaje es : ',destinoViaje)

// cantidad de dias
let cantidadDiasViaje = pront("Por favor ingrese la cantidad de dias para su viaje: ")
console.log(`La cantidiad de dias para su viaje es: ${cantidadDiasViaje}`)

//presupuesto del viaje 
let presupuestoViaje = pront("Por favor ingrese el presupuesto para su viaje: ")
console.log()
...
let presupuestoDiaEstimado = presupuesto / cantidadDiasViaje
